...
public class Controller {
	...
	public ResponseEntity<?> loginAdmin(@RequestBody Customer c) {
	...
	@PostMapping("/vehicle/findvehiclesbycustomerid")
	public ResponseEntity<?> findVehiclesByCustomerId(@RequestBody VehicleRegistration vehicle) throws Exception {
		
		
		List<VehicleRegistration>vehicles=custService.getVehicleDetails(vehicle.getCustomer_id());
		
		if(vehicles==null) {
			//System.out.println("---- null");
			return new ResponseEntity<String>("custId    "+vehicle.getCustomer_id()+"  not found",HttpStatus.OK);
		}
	...
	@PostMapping(value = "/directpay/findallpay/vehicle")
	public ResponseEntity<?> listAllDirectPayByVehicle(@RequestBody DirectPay pay) {
		List<DirectPay>l1=vehicleService.getDirectPayDetails(pay.getPolicy_id());
	...
	@PostMapping(value = "/registeredpay/findallpay/vehicle")
	public ResponseEntity<?> listAllRegisteredPayByVehicle(@RequestBody RegisteredPay pay) {
		List<RegisteredPay>l1=vehicleService.getRegisteredPayDetails(pay.getPolicy_id());
	...
	@PostMapping("/accidentclaim/findaccidentclaimbyid")
	public ResponseEntity<?> findAccidentClaimById(@RequestBody AccidentClaim accidentclaim) throws Exception {
		
		if(accidentclaim.getClaim_id().equals("P001"))
		throw new Exception();
		
		accidentclaim=accidentclaimservice.findById(accidentclaim.getClaim_id()).get();
		
		if(accidentclaim==null) {
			//System.out.println("---- null");
			return new ResponseEntity<String>("claim_id   "+accidentclaim.getClaim_id()+"  not found",HttpStatus.OK);
		}
	...
	@PostMapping(value = "/accidentclaim/approve")
	public ResponseEntity<?> approveAccidentClaim(@RequestBody AccidentClaim accidentclaim) {
		AccidentClaim tc=accidentclaimservice.findById(accidentclaim.getClaim_id()).get();
	...
	@PostMapping(value = "/accidentclaim/reject")
	public ResponseEntity<?> rejectAccidentClaim(@RequestBody AccidentClaim accidentclaim) {
		AccidentClaim tc=accidentclaimservice.findById(accidentclaim.getClaim_id()).get();
	...
	@PostMapping(value = "/theftclaim/approve")
	public ResponseEntity<?> approveTheftClaim(@RequestBody AccidentClaim accidentclaim) {
		TheftClaim tc=theftclaimservice.findById(accidentclaim.getClaim_id()).get();
		tc.setStatus("approved");
	...
	@PostMapping(value = "/theftclaim/reject")
	public ResponseEntity<?> rejectTheftClaim(@RequestBody TheftClaim accidentclaim) {
		TheftClaim tc=theftclaimservice.findById(accidentclaim.getClaim_id()).get();
		tc.setStatus("rejected");
		tc=theftclaimservice.save(tc);
		if(tc==null) {
	...
	public ResponseEntity<String> saveCancellation(@RequestBody Cancellation can) {
		
		//Customer c=custService.findById(can.getCustomer_id()).get();
		
		VehicleRegistration v=vehicleService.findById(can.getPolicy_id()).get();
		List<Cancellation>cancellist=custService.getCancellationDetails(can.getCustomer_id());
	    ...
	    List<DirectPay> l1=vehicleService.getDirectPayDetails(can.getPolicy_id());
		List<RegisteredPay>l2=vehicleService.getRegisteredPayDetails(can.getPolicy_id());
		Date max=new Date();
	...
	public ResponseEntity<?> findCancellationByCustomerId(@RequestBody Cancellation can) throws Exception {
		
		if(can.getCustomer_id().equals("P001"))
		throw new Exception();
		
		List<Cancellation>cancel=custService.getCancellationDetails(can.getCustomer_id());
	...
	@PostMapping(value = "/cancel/approve")
	public ResponseEntity<?> approvecancellation(@RequestBody Cancellation can) {
